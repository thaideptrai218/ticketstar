...
| #   | Pattern                                         | Status |
| --- | ----------------------------------------------- | ------ |
| 1   | Result Pattern                                  | Done   |
| 2   | API Response Envelope + ApiControllerBase       | Done   |
| 3   | Global Exception Middleware                     | Done   |
| 4   | Options Pattern (JwtOptions, GoogleAuthOptions) | Done   |
| 5   | Health Checks (/health/live, /health/ready)     | Done   |
| 7   | DI Extension Methods (clean Program.cs)         | Done   |
| 9   | Pagination (offset + cursor)                    | Done   |
| 10  | HTTP Status Codes (fix Register→201)            | Done   |
| 12  | Repository + UoW (generic + specific)           | Done   |
